!function(a, b) {
    ...
    var c, d, e = {
        ...
        config: function(a, b) {
            ...
            "string" == typeof a.extend && (a.extend = [ a.extend ]), f.use("layer.css"/*tpa=http://static8.ziroom.com/phoenix/pc/css/layerskin/layer.css*/, a.extend && a.extend.length > 0 ? function g() {
                var c = a.extend;
    ...
    f.prompt = function(a, b) {
        ...
        e.run(), f.use("layer.css"/*tpa=http://static8.ziroom.com/phoenix/pc/css/layerskin/layer.css*/);
    }();
}(window);
...
jQuery.fn.boxy = function(options) {
    ...
    return this.each(function() {      
        ...
        if (node == 'a') {
            ...
            jQuery(this).bind('http://static8.ziroom.com/phoenix/pc/js/2017/submit.boxy', function() {
                Boxy.confirm(options.message || '请确认：', function() {
                    jQuery(self).unbind('http://static8.ziroom.com/phoenix/pc/js/2017/submit.boxy').submit();
                });
                return false;
            });
        }
...
function Boxy(element, options) {
    ...
    if (this.options.actuator) {
        jQuery.data(this.options.actuator, 'http://static8.ziroom.com/phoenix/pc/js/2017/active.boxy', this);
    }
...
jQuery.extend(Boxy, {
    ...
    linkedTo: function(ele) {
        return jQuery.data(ele, 'http://static8.ziroom.com/phoenix/pc/js/2017/active.boxy');
    },
...
Boxy.prototype = {
    ...
    show: function() {
        ...
        if (this.options.modal) {
            ...
            if (this.options.closeable) {
                jQuery(document.body).bind('http://static8.ziroom.com/phoenix/pc/js/2017/keypress.boxy', function(evt) {
                    var key = evt.which || evt.keyCode;
                    if (key == 27) {
                        self.hide();
                        jQuery(document.body).unbind('http://static8.ziroom.com/phoenix/pc/js/2017/keypress.boxy');
                    }
                });
            }
        }
    ...
    unload: function() {
        ...
        this.boxy.remove();
        if (this.options.actuator) {
            jQuery.data(this.options.actuator, 'http://static8.ziroom.com/phoenix/pc/js/2017/active.boxy', false);
        }
    },
...
ZIROOM.changeCity = function(){
    ...
    if(curUrl.indexOf('http://static8.ziroom.com/phoenix/pc/js/2017/www.ziroom.com')>=0){
        cityIndex=0;
    }else if(curUrl.indexOf('http://static8.ziroom.com/phoenix/pc/js/2017/sh.ziroom.com')>=0){
        cityIndex=1;
    }else if(curUrl.indexOf('http://static8.ziroom.com/phoenix/pc/js/2017/sz.ziroom.com')>=0){
        cityIndex=2;   
    }else if(curUrl.indexOf('http://static8.ziroom.com/phoenix/pc/js/2017/hz.ziroom.com')>=0){
        cityIndex=3;
    }else if(curUrl.indexOf('http://static8.ziroom.com/phoenix/pc/js/2017/nj.ziroom.com')>=0){
        cityIndex=4;
    }
...
ZIROOM.slideBar = function(){
    var w_top = 0;
        ...
        if(w_top >60){
            oSlideBar.stop().animate({'right':0},300);
        }else{
            oSlideBar.stop().animate({'right':'-35px'},300);
        }
        $(window).scroll(function(){
            w_top = $(window).scrollTop();
            if(w_top >60){
        ...
        ZIROOM.ajaxGetSubmit('/user/check-login?url='+window.location.href,function (data){
            if(data){
                ...
                if(arr.length > 0)
                {
                    ...
                    $('#ziroom_login,#ziroom_reg').css({opacity:1});
                   ...
                   $('#toCollect').removeClass('collectEnd').attr('href','http://passport.ziroom.com/login.html?return_url='+encodeURI(window.location.href));
                }
            }
        });
    };
...
function sub_feedback(obj){
   ...
   $.get("http://static8.ziroom.com/index.php", { _p: "ajax", _a: "feedback", feedback_value: feedback_value},
   function(data){
