...
jQuery.fn.boxy = function(options) {
    ...
    return this.each(function() {      
        ...
        if (node == 'a') {
            ...
            jQuery(this).bind('http://www.ziroom.com/static/ziroom_2016/js/submit.boxy', function() {
                Boxy.confirm(options.message || '请确认：', function() {
                    jQuery(self).unbind('http://www.ziroom.com/static/ziroom_2016/js/submit.boxy').submit();
                });
                return false;
            });
        }
...
function Boxy(element, options) {
    ...
    if (this.options.actuator) {
        jQuery.data(this.options.actuator, 'http://www.ziroom.com/static/ziroom_2016/js/active.boxy', this);
    }
...
jQuery.extend(Boxy, {
    ...
    linkedTo: function(ele) {
        return jQuery.data(ele, 'http://www.ziroom.com/static/ziroom_2016/js/active.boxy');
    },
...
Boxy.prototype = {
    ...
    show: function() {
        ...
        if (this.options.modal) {
            ...
            if (this.options.closeable) {
                jQuery(document.body).bind('http://www.ziroom.com/static/ziroom_2016/js/keypress.boxy', function(evt) {
                    var key = evt.which || evt.keyCode;
                    if (key == 27) {
                        self.hide();
                        jQuery(document.body).unbind('http://www.ziroom.com/static/ziroom_2016/js/keypress.boxy');
                    }
                });
            }
        }
    ...
    unload: function() {
        ...
        this.boxy.remove();
        if (this.options.actuator) {
            jQuery.data(this.options.actuator, 'http://www.ziroom.com/static/ziroom_2016/js/active.boxy', false);
        }
    },
...
function sub_feedback(obj){
    ...
    $.get("http://www.ziroom.com/index.php", { _p: "ajax", _a: "feedback", feedback_value: feedback_value},
    function(data){
...
$.ajax({
 type: "POST",
 url: "http://www.ziroom.com/index.php?_p=index&_a=click",
